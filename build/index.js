...
/* harmony import */ var _block_locking__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block-locking */ "./src/block-locking.jsx");
/* harmony import */ var _block_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block-utils */ "./src/block-utils.js");
/* harmony import */ var _nested_governance_loader__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./nested-governance-loader */ "./src/nested-governance-loader.js");
...
function setup() {
  if (VIP_GOVERNANCE.error) {
    (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.dispatch)(_wordpress_notices__WEBPACK_IMPORTED_MODULE_4__.store).createErrorNotice(VIP_GOVERNANCE.error, {
      id: 'wpcomvip-governance-error',
      isDismissible: true,
      actions: [{
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Open governance settings'),
  ...
  (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__.addFilter)('blockEditor.__unstableCanInsertBlockType', `wpcomvip-governance/block-insertion`, (canInsert, blockType, rootClientId, {
    getBlock
  }) => {
    if (canInsert === false) {
      return canInsert;
    ...
    if (rootClientId) {
      ...
      const {
        getBlockParents,
        getBlockName
      } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.store);
    ...
    const isAllowed = (0,_block_utils__WEBPACK_IMPORTED_MODULE_6__.isBlockAllowedInHierarchy)(blockType.name, parentBlockNames, governanceRules);
     ...
     *                                    rules for the current user.
     */
    return (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__.applyFilters)('vip_governance__is_block_allowed_for_insertion', isAllowed, blockType.name, parentBlockNames, governanceRules);
  });
  const nestedSettings = VIP_GOVERNANCE.nestedSettings;
  const nestedSettingPaths = (0,_nested_governance_loader__WEBPACK_IMPORTED_MODULE_7__.getNestedSettingPaths)(nestedSettings);
  ...
  (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__.addFilter)('blockEditor.useSetting.before', `wpcomvip-governance/nested-block-settings`, (result, path, clientId, blockName) => {
    if (!blockName) {
      return result;
    }
    ...
    nestedNonWildcardPaths[blockName][path] === true) {
      const blockNamePath = [clientId, ...(0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.store).getBlockParents(clientId, /* ascending */true)].map(candidateId => (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.store).getBlockName(candidateId)).reverse();
      ({
        value: result
      } = (0,_nested_governance_loader__WEBPACK_IMPORTED_MODULE_7__.getNestedSetting)(blockNamePath, path, nestedSettings));
      ...
      for (const nestedBlockName in nestedWildcardPaths) {
        if ((0,_block_utils__WEBPACK_IMPORTED_MODULE_6__.doesBlockNameMatchBlockWildcard)(blockName, nestedBlockName) &&
        // eslint-disable-next-line security/detect-object-injection
  ...
  if (governanceRules?.allowedBlocks) {
    (0,_block_locking__WEBPACK_IMPORTED_MODULE_5__.setupBlockLocking)(governanceRules);
  }
}
setup();
})();
